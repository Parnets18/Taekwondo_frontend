      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="w-12 h-12 text-yellow-400 mt-1" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">yesh18390@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link to="/club-rules" onClick={scrollToTop} className="text-gray-400 hover:text-white text-sm transition-colors">Club Rules and Regulations</Link>
          </div>
        </div>
      </div>
    </footer>
