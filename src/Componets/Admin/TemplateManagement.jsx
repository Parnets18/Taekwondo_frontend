...
const TemplateManagement = () => {
  ...
  const handlePreviewTemplate = async (templateId) => {
    try {
      setLoading(true);
      const response = await axios.get(
        `${API_BASE_URL}/certificate-templates/${templateId}/preview`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
          responseType: "blob",
        },
  ...
  const handleToggleTemplate = async (templateId, isActive) => {
    try {
      await axios.put(
        `${API_BASE_URL}/certificate-templates/${templateId}`,
        { isActive: !isActive },
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        },
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() =>
                        handleToggleTemplate(template._id, template.isActive)
                      }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="special_achievement">
                          Special Achievement
                        </option>
                      </select>
                    </div>
                    ...
                    {/* Styling */}
                    <h4 className="text-md font-medium text-gray-900 pt-4">
                      Styling
                    </h4>
                        ...
                        >
                          <div className="text-sm">
                            ...
                            <span className="text-gray-500 ml-2">
                              ...
                              {field.size.width}x{field.size.height}
                            </span>
                          </div>
                          <button
                            type="button"
