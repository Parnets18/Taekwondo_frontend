    ...
    <div className="p-6">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <button
          ...
          style={
            activeTab === "locations" ? { backgroundColor: "#006CB5" } : {}
          }
        >
          Class Locations (
          {locations.filter((loc) => loc.type === "location").length})
        </button>
        <button
        ...
        >
          School Partnerships (
          {locations.filter((loc) => loc.type === "school").length})
        </button>
      </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      timings: { ...formData.timings, days: e.target.value },
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      timings: { ...formData.timings, time: e.target.value },
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none"
