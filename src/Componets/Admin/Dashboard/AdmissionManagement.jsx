...
function AdmissionManagement() {
  ...
  useEffect(() => {
    const loadAdmissions = async () => {
      try {
        ...
        const pendingApplications = fetchedAdmissions.filter(
          (admission) => admission.status === "pending",
        ).length;
        const approvedApplications = fetchedAdmissions.filter(
  ...
  const handleStatusUpdate = async (
    ...
    try {
      ...
      const pendingApplications = updatedAdmissions.filter(
        (admission) => admission.status === "pending",
      ).length;
      const approvedApplications = updatedAdmissions.filter(
        (admission) => admission.status === "approved",
      ).length;
  ...
  const viewAdmissionDetails = (admissionId) => {
    const admission = admissions.find(
      (admission) => admission._id === admissionId,
    );
    if (admission) {
  ...
  const handleDeleteAdmission = async (admissionId) => {
    if (
      window.confirm(
        "Are you sure you want to permanently delete this admission application? This action cannot be undone and will remove the application from the database forever.",
      )
    ) {
      try {
        // Get auth token from localStorage
        ...
        if (response.ok) {
          ...
          const thisMonthApplications = updatedAdmissions.filter(
            (admission) => {
              const submittedDate = new Date(admission.submittedAt);
              return submittedDate >= thisMonth;
            },
                      ...
                      filteredAdmissions.map((admission) => (
                        ...
                        >
                          <td className="px-6 py-4">
                            {admission.photo ? (
                              <img
                                src={`https://cwtakarnataka.com/${admission.photo.replace(/\\/g, "/").replace(/^.*uploads/, "uploads")}`}
                                alt={admission.name}
                          ...
                          <td className="px-6 py-4">
                            <div className="font-bold text-slate-900 uppercase">
                              {admission.name || admission.fullName}
                            </div>
                            {admission.studentId && (
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm text-slate-700">
                              {admission.mobileNumber || admission.phone}
                            </div>
                          ...
                          <td className="px-6 py-4">
                            <span className="text-slate-800 font-semibold">
                              {admission.age ||
                                calculateAge(admission.dateOfBirth)}{" "}
                              yrs
                            </span>
                          </td>
                          <td className="px-6 py-4">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex gap-3">
                              <button
                                onClick={() =>
                                  viewAdmissionDetails(admission._id)
                                }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2 bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900 font-bold text-lg uppercase">
                        {selectedAdmission.name || selectedAdmission.fullName}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.mobileNumber ||
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.emergencyContact || "Not provided"}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.aadhaarNumber || "Not provided"}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.bloodGroup || "Not provided"}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.height
                          ? `${selectedAdmission.height} cm`
                          : "Not provided"}
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.weight
                          ? `${selectedAdmission.weight} kg`
                          : "Not provided"}
                      </p>
                    </div>
                    ...
                    <div className="md:col-span-2 bg-slate-50 p-4 rounded-lg">
                      ...
                      <p className="text-slate-900">
                        {selectedAdmission.physicalDisorder || "None"}
                      </p>
                    </div>
                    ...
                    {selectedAdmission.photo && (
                      <div className="md:col-span-2 bg-slate-50 p-4 rounded-lg">
                        ...
                        <img
                          src={`https://cwtakarnataka.com/${selectedAdmission.photo.replace(/\\/g, "/").replace(/^.*uploads/, "uploads")}`}
                          alt="Student"
