...
import { FaPlus, FaEdit, FaTrash, FaTimes, FaArrowUp, FaArrowDown, FaEye, FaTags, FaSearch, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
...
export default function MoralCultureManagement() {
  ...
  const filtered = useMemo(() => {
    let rows = filterTab === 'all' ? items : items.filter(i => i.tab === filterTab);
