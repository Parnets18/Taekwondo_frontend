        ...
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center animate-fadeIn">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 mb-8">
            <p className="text-gray-800 text-lg leading-relaxed">
              We appreciate you reaching out to us! Our team will carefully
              review your message and get back to you within{" "}
              <span className="font-semibold">24 hours</span>. Thank you for
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Ready to start your martial arts journey? Have questions about our
            programs? We're here to help you every step of the way.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-3xl p-8 shadow-2xl h-full">
                ...
                <p className="text-gray-600 mb-8 text-sm">
                  We're here to answer your questions and help you begin your
                  ...
                  <div className="group">
                    <div className="flex items-start space-x-4 p-4 rounded-2xl bg-amber-50 border border-amber-100 hover:bg-amber-100 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      <div className="w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0 group-hover:rotate-6 transition-transform duration-300">
                        <FaMapMarkerAlt
                          style={{ fontSize: "1.75rem", color: "#006CB5" }}
                        />
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed">
                          #368/A, 3rd Main, 4th Phase, 707 CHS, Near Shristi
                          College, Yelahanka New Town, Bengaluru -560064
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    <div className="flex items-start space-x-4 p-4 rounded-2xl bg-green-50 border border-green-100 hover:bg-green-100 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      ...
                      <div className="flex-1">
                        ...
                        <a
                          href="tel:+917259113288"
                          className="text-sm text-gray-700 hover:text-green-600 transition-colors block font-semibold"
                        >
                          +91 7259113288
                        </a>
                        <a
                          href="tel:+919663333247"
                          className="text-sm text-gray-700 hover:text-green-600 transition-colors block font-semibold"
                        >
                          +91 9663333247
                        </a>
                  ...
                  <div className="group">
                    <div className="flex items-start space-x-4 p-4 rounded-2xl bg-blue-50 border border-blue-100 hover:bg-blue-100 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      ...
                      <div className="flex-1">
                        ...
                        <a
                          href="mailto:contact@cwtakarnataka.com"
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        borderColor: formData.inquiryType ? "#006CB5" : "",
                      }}
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      style={{
                        borderColor:
                          formData.message.length >= 10 ? "#006CB5" : "",
                      }}
                    ></textarea>
            ...
            <div className="w-full max-w-4xl">
              <div className="text-center mb-12">
                <h2
                  ...
                  style={{ color: "#006CB5" }}
                >
                  Find <span style={{ color: "#006CB5" }}>Our</span>{" "}
                  <span style={{ color: "#006CB5" }}>Location</span>
                </h2>
                <p className="text-base text-gray-700">
                  Visit our dojang and experience authentic Taekwon-Do training
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-3xl p-12 shadow-2xl">
            <div className="text-center mb-12">
              ...
              >
                Frequently Asked{" "}
                <span style={{ color: "#006CB5" }}>Questions</span>
              </h2>
              <p className="text-base text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div
                className="bg-gray-50 p-6 rounded-2xl transform hover:scale-105 hover:rotate-1 transition-all duration-500 group"
                style={{
              ...
              >
                ...
                <p className="text-base text-gray-700">
                  We welcome students from 6 years old to adults. Our programs
              ...
              >
                ...
                <p className="text-base text-gray-700">
                  No prior experience is required. Our Foundation Level program
                  is perfect for complete beginners.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-base text-gray-700">
                  Just comfortable workout clothes and a water bottle. We
                  provide all necessary equipment for beginners.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-base text-gray-700">
                  Yes! We offer free trial classes so you can experience our
                  training before making a commitment.
                </p>
              </div>
            </div>
          </div>
