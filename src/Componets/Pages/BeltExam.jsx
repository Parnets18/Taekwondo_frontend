...
function BeltExam() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      !formData.gmail ||
      !formData.appearingForGrade ||
      !formData.presentBelt ||
        ...
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center animate-fadeIn">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 mb-8">
            <p className="text-gray-800 text-lg leading-relaxed">
              Good luck with your{" "}
              <span className="font-bold text-red-600">belt examination</span>!
              We'll contact you with the exam date and venue details within{" "}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative z-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">
            Belt <span className="text-white">Examination</span>{" "}
          ...
          <p className="text-base sm:text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Register for your next belt level examination. Complete the form
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            >
              <div className="flex items-center justify-center mb-2">
                ...
                >
                  Individual Colour Belt Exam Form
                </h2>
              </div>
              ...
              <div className="border-t-2 border-slate-200 pt-6 mt-8">
                <div className="flex items-start space-x-3 mb-6">
                  ...
                  <label className="text-sm text-slate-600 leading-relaxed">
                    ...
                    Undersigned do hereby solemnly affirm, declare and confirm
                    for myself, executors and administrators, that I indemnify
                    the organiser, officials, participants, etc., holding myself
                    personally responsible for damages, injuries, accidents,
                    claims, demand etc., waving all prerogative rights, whatever
