  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8" style={{ border: '3px solid #006CB5' }}>
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-4 bg-white shadow-lg" style={{ border: '4px solid #006CB5' }}>
              <svg className="w-10 h-10" style={{ color: '#006CB5' }} fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
              </svg>
            </div>
            <h2 className="text-3xl font-bold mb-2" style={{ color: '#006CB5' }}>Student Portal</h2>
            <p className="text-gray-600 text-lg">Access your certificates, progress, and achievements</p>
          </div>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 text-center">
              <div className="p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ border: '2px solid #006CB5' }}>
                <svg className="w-10 h-10 mx-auto mb-2" style={{ color: '#006CB5' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                </svg>
                <p className="text-sm font-semibold" style={{ color: '#006CB5' }}>Certificates</p>
              </div>
              <div className="p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ border: '2px solid #006CB5' }}>
                <svg className="w-10 h-10 mx-auto mb-2" style={{ color: '#006CB5' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
                <p className="text-sm font-semibold" style={{ color: '#006CB5' }}>Progress</p>
              </div>
              <div className="p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ border: '2px solid #006CB5' }}>
                <svg className="w-10 h-10 mx-auto mb-2" style={{ color: '#006CB5' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                </svg>
                <p className="text-sm font-semibold" style={{ color: '#006CB5' }}>Achievements</p>
              </div>
            </div>

            <p className="mt-6 text-center text-sm text-gray-600">
              Don't have an account?{' '}
              <a href="/admission" className="font-semibold hover:underline" style={{ color: '#006CB5' }}>
                Join Now
              </a>
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="relative p-6 border-b border-gray-200">
                ...
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-3" style={{ backgroundColor: '#fef2f2', border: '2px solid rgba(239, 68, 68, 0.1)' }}>
                    <svg className="w-8 h-8" style={{ color: '#ef4444' }} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">Student Login</h3>
                ...
                <form onSubmit={async (e) => {
                  ...
                  <div className="mb-4">
                    <div className="flex items-center bg-gray-50 border border-gray-300 rounded-xl px-4 py-3">
                      <svg className="w-5 h-5 mr-3" style={{ color: '#ef4444' }} fill="currentColor" viewBox="0 0 24 24">
